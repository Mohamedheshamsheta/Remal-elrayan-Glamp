...
export type Language = "en" | "ar" | "es" | "fr" | "de" | "ja" | "el";
...
const translations: Record<Language, TranslationSet> = {
  ...
  el: {
    ...
    restaurant: "Εστιατόριο Lummayya",
    experiences: "Συναντήσεις & Εμπειρίες",
    policies: "Κανόνες Glamp",
    wadiElRayan: "Wadi El Rayan",
    egypt: "Αίγυπτος",
    replay: "Επανάληψη",
    nationalityLabel: "Εθνικότητα",
    egyptian: "Αιγύπτιος",
    nonEgyptian: "Μη Αιγύπτιος",
    coordinates: "ΣΥΝΤΕΤΑΓΜΕΝΕΣ",
    classification: "ΚΑΤΗΓΟΡΙΟΠΟΙΗΣΗ",
    classificationValue: "Ultra-Luxe Οικολογικό Καταφύγιο",
    fayoumEgypt: "WADI EL RAYAN • FAYOUM • ΑΙΓΥΠΤΟΣ",
    preloaderEst: "ΑΙΓΥΠΤΟΣ • ΙΔΡ. 2021",
    preloaderSilent: "SILENT BOUTIQUE LUXURY",
    preloaderStage0: "Επιθεώρηση αμμόλοφων Wadi El Rayan...",
    preloaderStage1: "Σχεδίαση γεωδαιτικής αρχιτεκτονικής...",
    preloaderStage2: "Επιμέλεια στοιχείων νερού της ερήμου...",
    preloaderStage3: "Τελειοποίηση φιλοξενίας ήσυχης πολυτέλειας...",
    exploreRetreat: "ΕΞΕΡΕΥΝΗΣΤΕ ΤΟ ΚΑΤΑΦΥΓΙΟ",
    established2021: "ΙΔΡΥΘΗΚΕ ΤΟ 2021 • THE WILDERNESS COONSOON",
    glampDescription: "Ένα αναγνωρισμένο καταφύγιο πολυτελούς glamping χαμηλού περιβαλλοντικού αποτυπώματος, που βρίσκεται κομψά πάνω στους σιωπηλούς χρυσούς αμμόλοφους της προστατευόμενης περιοχής Wadi El Rayan. Συνδυάζει την αυθεντική φύση της ερήμου με την κορυφαία φιλοξενία μπουτίκ.",
    conceptPhilosophy: "ΦΙΛΟΣΟΦΙΑ & ΟΡΑΜΑ",
    redefiningLuxuryTitle: "Επαναπροσδιορίζοντας τον Πολυτελή Οικοτουρισμό",
    sandMeaning: "Στα αραβικά, η λέξη \"Remal\" σημαίνει άμμος. Είναι το θεμέλιο της ισορροπίας—γιατί χωρίς την άμμο, δεν θα υπήρχαν δάση. Το Remal el Rayan Glamp δημιουργήθηκε από βαθιά αγάπη και σεβασμό για το περιβάλλον της ερήμου, την κληρονομιά και τους ανθρώπους του.",
    adventureComfort: "Πιστεύουμε ότι η πραγματική περιπέτεια δεν πρέπει ποτέ να συμβιβάζεται με την απόλυτη άνεση. Ως πρωτοπόροι της πρώτης πολυτελούς εμπειρίας glamping αυτού του είδους στην Αίγυπτο, προσκαλούμε τους επισκέπτες μας να ζήσουν το μεγαλείο της ερήμου με στυλ. Μέσα από καινοτόμες αρχιτεκτονικές δομές σκηνών και πολυτελείς Γεωδαιτικούς Θόλους, που διαθέτουν ιδιωτικά τζακούζι και ντους κάτω από τα αστέρια, έχουμε αναβαθμίσει τον ύπνο κάτω από τον ουρανό στο επόμενο επίπεδο εκλεπτυσμένης πολυτέλειας.",
    balanceQuote: "\"Χωρίς την άμμο, δεν θα υπήρχαν δάση.\" — Το Θεμέλιο της Ισορροπίας.",
    boardVision: "ΔΙΟΙΚΗΤΙΚΟ & ΕΚΤΕΛΕΣΤΙΚΟ ΟΡΑΜΑ",
    strategicRepositioning: "Στρατηγική Επανατοποθέτηση",
    strategicDesc: "Καθοδηγούμενη από ένα διορατικό Διοικητικό Συμβούλιο και μια εξαιρετικά στρατηγική ομάδα διαχείρισης, η αποστολή μας εκτείνεται πολύ πέρα ​​από τη φιλοξενία μπουτίκ. Ηγούμαστε ενεργά μιας στρατηγικής στροφής για την αναζωογόνηση του βιωματικού οικοτουρισμού και του πολυτελούς glamping στην Αίγυπτο. Αξιοποιώντας τη βαθιά τεχνογνωσία της ομάδας μας στον τομέα της φιλοξενίας, η διοίκηση δεσμεύεται να καθιερώσει το Wadi El Rayan—μια εξαιρετική περιοχή παγκόσμιας κληρονομιάς της UNESCO—ως κορυφαίο παγκόσμιο προορισμό για εύπορους, πολιτιστικά ανήσυχους ταξιδιώτες.",
    heritageImpact: "Η ΟΜΑΔΑ ΜΑΣ & ΟΙΚΟΛΟΓΙΚΟ ΑΠΟΤΥΠΩΜΑ",
    sustainableHeritage: "Βιώσιμη Κληρονομιά",
    heritageDesc: "Πίσω από κάθε ευτυχισμένη στιγμή στην έρημο βρίσκεται η αφοσιωμένη, παγκόσμιας κλάσης ομάδα μας. Λειτουργώντας με μια εξαιρετικά αποτελεσματική προσέγγιση, η ομάδα μας γεφυρώνει άψογα την κορυφαία φιλοξενία με την τοπική κληρονομιά. Συνεργαζόμαστε στενά με την τοπική κοινότητα του Fayoum, στηρίζοντας την παραδοσιακή χειροποίητη κεραμική και τους ντόπιους τεχνίτες. Στο Remal el Rayan, η ηγεσία και η ομάδα μας διασφαλίζουν ότι το πολυτελές ταξίδι σας υποστηρίζει άμεσα τον βιώσιμο κοινωνικό αντίκτυπο και την προστασία του περιβάλλοντος.",
    locationPortfolio: "ΤΟ ΧΑΡΤΟΦΥΛΑΚΙΟ ΤΟΠΟΘΕΣΙΑΣ",
    sacredOasisTitle: "Μια Ιερή Όαση μέσα στο Wadi El Rayan",
    sacredOasisDesc1: "Το Wadi El Rayan είναι ένα παγκοσμίως αναγνωρισμένο, προστατευόμενο φυσικό καταφύγιο που βρίσκεται στο Κυβερνείο Fayoum, νοτιοδυτικά του Καΐρου. Χαρακτηρίζεται από τη μοναδική τοπογραφία της ερήμου, όπου οι χρυσοί αμμόλοφοι κατεβαίνουν δυναμικά σε υπέροχες αλμυρές λίμνες με καταγάλανα νερά.",
    sacredOasisDesc2: "Το Remal El Rayan βρίσκεται βαθιά μέσα σε αυτό το ήσυχο καταφύγιο, πλήρως ιδιωτικό και προστατευμένο από κοντινές εκπομπές φωτός ή κίνηση. Εδώ, η φωτορύπανση είναι ανύπαρκτη, προσφέροντας στους επισκέπτες πεντακάθαρη θέα στον έναστρο ουρανό απευθείας από τις premium εξέδρες των θόλων.",
    distanceCairo: "ΑΠΟΣΤΑΣΗ ΑΠΟ ΚΑΪΡΟ",
    distanceCairoVal: "140 χλμ. (2.5 ώρες)",
    sandType: "ΤΥΠΟΣ ΑΜΜΟΥ",
    sandTypeVal: "Χρυσός Αμμόλοφος Πυριτίας",
    nearestWaterbody: "ΚΟΝΤΙΝΟΤΕΡΟΣ ΥΔΡΟΒΙΟΤΟΠΟΣ",
    nearestWaterbodyVal: "Μαγική Λίμνη Fayoum",
    placeHistory: "ΙΣΤΟΡΙΑ ΤΟΠΟΥ",
    placeHistoryVal: "Ξεκινά το 2021",
    geoGridMap: "ΓΕΩΓΡΑΦΙΚΟΣ ΧΑΡΤΗΣ",
    campLocationMarker: "Δείκτης Τοποθεσίας Camp",
    campMarkerDesc: "Τοποθετημένο πίσω από τις πανύψηλες προστατευτικές κορυφογραμμές των αμμόλοφων, διασφαλίζοντας αυστηρά την ειρήνη και την ήσυχη χαλάρωση.",
    adminHospitality: "ΔΙΟΙΚΗΣΗ & ΗΓΕΣΙΑ ΦΙΛΟΞΕΝΙΑΣ",
    orgTeamTitle: "Η Οργάνωση της Ομάδας μας",
    orgTeamDesc: "Με περηφάνια διοικείται από μια αφοσιωμένη ομάδα 50 ντόπιων και διεθνών επαγγελματιών φιλοξενίας στο χώρο του camp.",
    chairman: "Πρόεδρος",
    ceo: "Διευθύνων Σύμβουλος & Συνιδρυτής",
    generalManager: "Γενικός Διευθυντής",
    restaurantManager: "Διευθυντής Εστιατορίου",
    executiveChef: "Executive Chef",
    reservationsManager: "Υπεύθυνος Κρατήσεων",
    receptionManager: "Υπεύθυνος Υποδοχής",
    accountantManager: "Υπεύθυνος Λογιστηρίου",
    vipHostingSatellite: "VIP ΦΙΛΟΞΕΝΙΑ",
    exclusiveConciergeInquiries: "ΑΠΟΚΛΕΙΣΤΙΚΕΣ ΚΡΑΤΗΣΕΙΣ & ΥΠΗΡΕΣΙΕΣ CONCIERGE",
    accomTitle: "REMAL ΠΟΛΥΤΕΛΕΙΣ ΓΕΩΔΑΙΤΙΚΟΙ ΘΟΛΟΙ",
    accomSub: "ΑΡΧΙΤΕΚΤΟΝΙΚΑ ΚΑΤΑΦΥΓΙΑ ULTRA-LUXURY",
    accomDesc: "Σχεδιασμένοι για να συνδυάζουν την αυθεντικότητα της άγριας ερήμου με την κορυφαία αρχιτεκτονική άνεση. Κάθε premium θόλος διαθέτει μόνωση διπλού στρώματος, ιδιωτική πανοραμική εξέδρα θέασης, θεραπευτικό τζακούζι και ντους κάτω από τα αστέρια.",
    roomBookingNotes: "Κανονισμοί Κρατήσεων Δωματίων & Σημείωση Τιμών",
    egyptianPriceNotice: "Απαιτείται επαλήθευση αιγυπτιακής ταυτότητας ή άδειας διαμονής κατά την υποδοχή. Οι τιμές Σαββατοκύριακου ισχύουν για τις διανυκτερεύσεις Πέμπτης & Παρασκευής.",
    nonEgyptianPriceNotice: "Οι τιμές για μη Αιγύπτιους είναι πληρωτέες σε USD ή σε ισότιμο σημαντικό ξένο νόμισμα. Απαιτείται εγγύηση κατά το check-in.",
    maxGuests: "Μέγιστος Αριθμός Επισκεπτών",
    perNight: "ανά νύχτα",
    viewInterior: "Προβολή Εσωτερικού Χώρου",
    viewExterior: "Προβολή Εξωτερικής Εξέδρας",
    reserveThisDome: "Κράτηση αυτού του Θόλου",
    amenitiesLabel: "Παροχές Boutique",
    featuresLabel: "Στρατηγικά Χαρακτηριστικά",
    lakeDiningTitle: "ΔΕΙΠΝΟ ΣΤΗ ΛΙΜΝΗ LUMMAYYA",
    lakeDiningSub: "ΓΑΣΤΡΟΝΟΜΙΑ ΤΗΣ ΕΡΗΜΟΥ ΔΙΠΛΑ ΣΤΗ ΜΑΓΙΚΗ ΛΙΜΝΗ",
    lakeDiningDesc: "Η κουζίνα μας δίπλα στη λίμνη σερβίρει αυθεντικές, σιγομαγειρεμένες, βιολογικές συνταγές των Βεδουίνων και του Fayoum. Κάθε πιάτο είναι καρυκευμένο με φρέσκα ντόπια βότανα της ερήμου και φτιαγμένο από την τοπική γαστρονομική μας ομάδα.",
    breakfastMenu: "Πρωινό Βεδουίνων",
    lunchMenu: "Παραδοσιακά Σιγομαγειρεμένα Κυρίως Πιάτα",
    dinnerMenu: "Ψητά δίπλα στη Λίμνη & Γλυκά",
    exclVat: "* Οι τιμές του μενού υπόκεινται σε χρέωση υπηρεσιών εστιατορίου 12%. Τα πακέτα ημερήσιας χρήσης εξαιρούνται.",
    bookingFormTitle: "ΕΓΓΡΑΦΗ ΓΙΑ ΔΕΙΠΝΟ & ΗΜΕΡΗΣΙΑ ΧΡΗΣΗ LUMMAYYA",
    pricingGuideTitle: "ΔΙΑΔΡΑΣΤΙΚΟΣ ΥΠΟΛΟΓΙΣΤΗΣ ΧΡΕΩΣΗΣ & ΠΡΟΣΦΟΡΑΣ",
    roomCategoriesLiveRates: "ΚΑΤΗΓΟΡΙΕΣ ΔΩΜΑΤΙΩΝ & ΖΩΝΤΑΝΕΣ ΤΙΜΕΣ",
    selectRateBasis: "ΕΠΙΛΕΞΤΕ ΒΑΣΗ ΧΡΕΩΣΗΣ",
    weekdaysLabel: "Καθημερινές (Κυρ-Τετ)",
    weekendLabel: "Σαββατοκύριακο (Πέμ-Σάβ)",
    selectOccupancy: "ΕΠΙΛΕΞΤΕ ΕΝΟΙΚΙΑΣΗ",
    calculatedRate: "ΥΠΟΛΟΓΙΣΜΕΝΗ ΤΙΜΗ (Με Πρωινό)",
    approxLabel: "Περίπου",
    exclTaxes: "Ανά διανυκτέρευση • Χωρίς Φόρους",
    includedComfort: "ΠΕΡΙΛΑΜΒΑΝΟΜΕΝΗ ΑΝΕΣΗ",
    exteriorLabel: "Εξωτερικό",
    interiorLabel: "Εσωτερικό",
    selectNationalityRequired: "ΕΠΙΛΕΞΤΕ ΕΘΝΙΚΟΤΗΤΑ (ΑΠΑΙΤΕΙΤΑΙ)",
    egyptianIdOption: "Αιγύπτιος / Κάτοικος",
    nonEgyptianOption: "Διεθνής Επισκεπτής",
    currencyPreferenceTitle: "ΠΡΟΤΙΜΗΣΗ ΝΟΜΙΣΜΑΤΟΣ",
    egpOption: "EGP",
    usdOption: "USD ($)",
    receptionServices: "ΥΠΟΔΟΧΗ & ΚΕΝΤΡΟ ΕΜΠΕΙΡΙΩΝ",
    receptionServicesDesc: "Κλείστε εκ των προτέρων τις πολυτελείς εμπειρίες σας στην έρημο, ιδιωτικές μεταφορές με το στόλο μας ή εξατομικευμένες εταιρικές δραστηριότητες και κινηματογραφικούς γάμους απευθείας μέσω της ομάδας concierge.",
    directConciergeActive: "ΕΝΕΡΓΟ DIRECT CONCIERGE",
    activitiesTab: "Δραστηριότητες",
    transportationTab: "Μεταφορά",
    teambuildingTab: "Team Building",
    weddingsTab: "Γάμοι & Εκδηλώσεις",
    importantBookingNotice: "ΣΗΜΑΝΤΙΚΗ ΣΗΜΕΙΩΣΗ ΚΡΑΤΗΣΗΣ",
    importantBookingNoticeDesc: "Όλες οι δραστηριότητες υπόκεινται στις καιρικές συνθήκες και πρέπει να συντονίζονται με την υποδοχή τουλάχιστον 24 ώρες νωρίτερα για να διασφαλιστεί η διαθεσιμότητα.",
    bookedOnSite: "ΚΡΑΤΗΣΗ ΣΤΟ ΧΩΡΟ",
    officialTariff: "ΕΠΙΣΗΜΟΣ ΤΙΜΟΚΑΤΑΛΟΓΟΣ",
    bookViaConcierge: "Κράτηση μέσω Concierge",
    privateFleetTransfers: "ΙΔΙΩΤΙΚΕΣ ΜΕΤΑΦΟΡΕΣ",
    exclusiveCairoToCamp: "Αποκλειστικές Ιδιωτικές Μεταφορές Κάιρο προς Camp",
    transportDesc: "Ταξιδέψτε από το Κάιρο απευθείας στο πολυτελές μας camp στο Wadi El Rayan με απόλυτη άνεση. Παρέχουμε premium κλιματιζόμενα οχήματα με επαγγελματίες οδηγούς που γνωρίζουν τις διαδρομές της ερήμου.",
    standardTransfer: "ΤΥΠΙΚΗ ΜΕΤΑΦΟΡΑ",
    standardCarTitle: "Chauffeur SUV (Έως 4 Επισκέπτες)",
    standardCarDesc: "Μια ιδιωτική μεταφορά υψηλής άνεσης με SUV που ξεκινά από το Διεθνές Αεροδρόμιο του Καΐρου ή οποιαδήποτε καθορισμένη διεύθυνση στο Κάιρο απευθείας στο camp.",
    premiumOption: "PREMIUM ΕΠΙΛΟΓΗ",
    premiumCarTitle: "Luxury 4x4 Off-Road (Έως 3 Επισκέπτες)",
    premiumCarDesc: "Για ταξιδιώτες που αναζητούν μια ολοκληρωμένη εμπειρία περιπέτειας 4x4 στην έρημο απευθείας από το Κάιρο. Διατίθενται προσαρμοσμένες στάσεις διαδρομής.",
    customQuote: "ΠΡΟΣΩΠΙΚΗ ΠΡΟΣΦΟΡΑ",
    cairoFayoum: "Κάιρο προς Fayoum",
    bespokeRetreats: "ΕΞΑΤΟΜΙΚΕΥΜΕΝΑ RETREATS",
    corporateOutingsTitle: "Εταιρικές Αποδράσεις & Στρατηγικές Σύνοδοι",
    corporateOutingsDesc: "Επαναπροσδιορίστε την ομαδική εργασία στους αμμόλοφους. Διοργανώνουμε πλήρως προσαρμοσμένα, πολυτελή retreats για ομάδες με εξωτερικούς χώρους εργασίας, δείπνα Βεδουίνων και εργαστήρια επιβίωσης στην έρημο.",
    exclusiveRetreatCapabilities: "ΔΥΝΑΤΟΤΗΤΕΣ ΑΠΟΚΛΕΙΣΤΙΚΟΥ RETREAT",
    exclusiveRetreatCapabilitiesDesc: "Διαμονή έως 40 άτομα, ρυθμίσεις θόλου παρουσιάσεων, δορυφορική σύνδεση υψηλής ταχύτητας και πλήρως οργανωμένες ομαδικές δραστηριότητες.",
    cinematicVenue: "ΚΙΝΗΜΑΤΟΓΡΑΦΙΚΟΣ ΧΩΡΟΣ",
    weddingsTitle: "Κινηματογραφικοί Γάμοι στην Έρημο",
    weddingsDesc: "Φιλοξενήστε μια αξέχαστη, εξαιρετικά πολυτελή γαμήλια τελετή με φόντο τους κυματιστούς αμμόλοφους του Fayoum και τη λαμπερή Μαγική Λίμνη. Ένα πραγματικά μαγικό σκηνικό για την ιδιαίτερη μέρα σας.",
    tailoredProduction: "ΠΡΟΣΑΡΜΟΣΜΕΝΗ ΠΑΡΑΓΩΓΗ",
    tailoredProductionDesc: "Πληρης υπηρεσία σχεδιασμού γάμου που περιλαμβάνει προσαρμοσμένη διακόσμηση εμπνευσμένη από τους Βεδουίνους, ατμοσφαιρικό φωτισμό κάτω από τα αστέρια, catering πέντε αστέρων από το Lummayya και ζωντανές μουσικές παραστάσεις.",
    whyFayoumTitle: "Γιατί ξεκινήσαμε από το Fayoum;",
    whyFayoumOpening: "Στο Remal elrayan glamp, το ταξίδι μας ξεκίνησε με ένα όραμα να έχουμε σημαντικό και θετικό αντίκτυπο. Όταν αναζητούσαμε μια τοποθεσία για να ξεκινήσουμε, το Fayoum της Αιγύπτου ξεχώρισε για τον μοναδικό συνδυασμό ιστορίας, πολιτισμού και, κυρίως, δυναμικής.",
    whyFayoumCradleTitle: "Fayoum: Ένα Λίκνο Δυνατοτήτων",
    whyFayoumCradleDesc: "Το Fayoum είναι μια από τις παλαιότερες πόλεις στον κόσμο, με πλούσια αγροτική κληρονομιά και μια ζωντανή κοινότητα. Ωστόσο, όπως πολλές περιοχές, αντιμετωρίζει προκλήσεις που παρουσιάζουν ευκαιρίες για ανάπτυξη και βιώσιμη εξέλιξη. Επιλέξαμε το Fayoum επειδή αναγνωρίσαμε ότι οι καινοτόμες λύσεις και η αφοσίωσή μας θα μπορούσαν πραγματικά να κάνουν τη διαφορά εδώ.",
    whyFayoumCommitmentTitle: "Η Δέσμευσή μας",
    whyFayoumCommitmentDesc: "Η αρχική μας εστίαση στο Fayoum είναι η εφαρμογή βιώσιμων πρακτικών που ενδυναμώνουν την τοπική κοινότητα, βελτιώνουν την ποιότητα ζωής και συμβάλλουν στη συνολική ευημερία της περιοχής. Πιστεύουμε ότι ξεκινώντας από εδώ, μπορούμε να θέσουμε ένα ισχυρό παράδειγμα για το πώς μπορεί να αναπτυχθεί η υπεύθυνη και προσεκτική ανάπτυξη.",
    mgmtTitle: "Η Φιλοσοφία Διαχείρισης: Χτισμένη από Μέσα",
    mgmtIntro: "Στο Remal, απορρίπτουμε σκόπιμα την παραδοσιακή οδό της εξωτερικής ανάθεσης της διαχείρισης μας σε εξωτερικές εταιρείες. Επειδή δεν διευθύνουμε απλώς ένα ακίνητο—είμαστε πρωτοπόροι σε ένα εντελώς νέο οικοσύστημα και καθορίζουμε ένα νέο σύνορο για τη φιλοξενία στην Αίγυπτο.\n\nΓια να ηγηθούμε αυτού του κινήματος, η κατεύθυνσή μας—υπό την καθοδήγηση των Mostafa Farouk, Mohamed Farouk και Mohamed Sheta—έχει τις ρίζες της στη δημιουργία ευέλικτων, προσαρμοστικών συστημάτων σχεδιασμένων να ενδυναμώνουν τους ανθρώπους μας και να αναβαθμίζουν την τοπική αγορά.",
    mgmtWhyHeader: "Γιατί Διαχειριζόμαστε το Δικό μας Μονοπάτι:",
    mgmtPioneeringTitle: "Πρωτοπορώντας σε μια Νέα Εποχή",
    mgmtPioneeringDesc: "Καθιερώνουμε ένα μοναδικό μοντέλο εκλεπτυσμένης φιλοξενίας που δεν μπορεί να αναπαραχθεί από άκαμπτες, τυποποιημένες διεθνείς εταιρείες διαχείρισης. Διατηρώντας την ηγεσία μας εσωτερική, διατηρούμε την ευελιξία να καινοτομούμε συνεχώς.",
    mgmtEmpoweringTitle: "Ενδυνάμωση της Τοπικής Κοινότητας",
    mgmtEmpoweringDesc: "Πιστεύουμε ότι η πραγματική βιωσιμότητα ξεκινά από τους ανθρώπους. Τα λειτουργικά μας συστήματα έχουν κατασκευαστεί για να καλλιεργούν, να εκπαιδεύουν και να υποστηρίζουν τα τοπικά ταλέντα, οδηγώντας άμεσα στην οικονομική και επαγγελματική ανάπτυξη της κοινότητας που αποκαλούμε σπίτι μας.",
    mgmtFamilyTitle: "Η Δύναμη της Οικογένειας & της Κληρονομιάς",
    mgmtFamilyDesc: "Δεν διαχειριζόμαστε απλώς προσωπικό, χτίζουμε μια οικογένεια. Το στυλ διαχείρισης μας είναι βαθιά εμποτισμένο με τις αυθεντικές παραδόσεις, τη ζεστασιά και τις αξίες της γης μας, διασφαλίζοντας ότι η εμπειρία κάθε επισκέπτη είναι βαθιά γειωμένη και ειλικρινά φιλόξενη.",
    mgmtFooter: "Στο Remal, πιστεύουμε ότι για να ανυψωθεί το μέλλον της αιγυπτιακής φιλοξενίας, το θεμέλιο πρέπει να χτιστεί από εκείνους που κατανοούν πραγματικά την ψυχή της.",
  }
};
